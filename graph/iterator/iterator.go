...
func (it *Error) Contains(*graph.IterationContext, graph.Value) bool {
	return false
}
...
func (it *Error) Next(*graph.IterationContext) bool {
	return false
}
...
func (it *Error) NextPath(*graph.IterationContext) bool {
	return false
}
